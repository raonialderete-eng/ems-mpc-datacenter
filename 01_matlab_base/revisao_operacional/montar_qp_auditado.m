...
if isfield(param,'disable_event_constraint') && param.disable_event_constraint
    PBESS_min_event(:)=0;
end
...
q.Nc=Nc;
q.idx_du=idx_du;
q.idx_pgrid=idx_pgrid;
q.idx_slack_load=idx_slack_load;
q.idx_slack_source=idx_slack_source;
q.idx_slack_recharge=idx_slack_recharge;
q.idx_slack_event=idx_slack_event;
q.u_livre=u_livre;
q.u_mat=u_mat;
q.PBESS_livre=PBESS_livre;
q.PBESS_mat=PBESS_mat;
q.SOC_livre=SOC_livre;
q.SOC_mat=SOC_mat;
q.Pgrid_mat=Pgrid_mat;
q.PBESS_min_event=PBESS_min_event;
q.Psource_ref=Psource_ref;
q.Psource_min_recharge=Psource_min_recharge;
q.dUmax=dUmax;
q.dUmin=dUmin;
q.modo_evento=modo_evento;
q.Pbase=Pbase;
q.Rbase=Rbase;
q.Kstep=Kstep;
q.L=L;
