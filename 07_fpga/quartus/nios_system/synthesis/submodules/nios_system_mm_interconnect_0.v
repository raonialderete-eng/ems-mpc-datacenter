...
module nios_system_mm_interconnect_0 (
	...
	wire  [18:0] onchip_s1_agent_m0_address;                                                 // onchip_s1_agent:m0_address -> onchip_s1_translator:uav_address
	...
	wire  [97:0] onchip_s1_agent_rf_source_data;                                             // onchip_s1_agent:rf_source_data -> onchip_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] onchip_s1_agent_rsp_fifo_out_data;                                          // onchip_s1_agent_rsp_fifo:out_data -> onchip_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                      // cmd_mux_003:src_valid -> onchip_s1_agent:cp_valid
	wire  [96:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> onchip_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                      // onchip_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [9:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> onchip_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                              // cmd_mux_003:src_startofpacket -> onchip_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                // cmd_mux_003:src_endofpacket -> onchip_s1_agent:cp_endofpacket
	...
	wire  [96:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> uart_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                      // uart_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [9:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> uart_s1_agent:cp_channel
	...
	wire  [97:0] pio_led_s1_agent_rf_source_data;                                            // pio_led_s1_agent:rf_source_data -> pio_led_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] pio_led_s1_agent_rsp_fifo_out_data;                                         // pio_led_s1_agent_rsp_fifo:out_data -> pio_led_s1_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> pio_led_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                      // pio_led_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [9:0] cmd_mux_006_src_channel;                                                    // cmd_mux_006:src_channel -> pio_led_s1_agent:cp_channel
	...
	wire  [97:0] pio_sw_s1_agent_rf_source_data;                                             // pio_sw_s1_agent:rf_source_data -> pio_sw_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] pio_sw_s1_agent_rsp_fifo_out_data;                                          // pio_sw_s1_agent_rsp_fifo:out_data -> pio_sw_s1_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_007_src_data;                                                       // cmd_mux_007:src_data -> pio_sw_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                      // pio_sw_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [9:0] cmd_mux_007_src_channel;                                                    // cmd_mux_007:src_channel -> pio_sw_s1_agent:cp_channel
	...
	wire  [97:0] pio_key_s1_agent_rf_source_data;                                            // pio_key_s1_agent:rf_source_data -> pio_key_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] pio_key_s1_agent_rsp_fifo_out_data;                                         // pio_key_s1_agent_rsp_fifo:out_data -> pio_key_s1_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_008_src_data;                                                       // cmd_mux_008:src_data -> pio_key_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                      // pio_key_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [9:0] cmd_mux_008_src_channel;                                                    // cmd_mux_008:src_channel -> pio_key_s1_agent:cp_channel
	...
	wire  [18:0] pio_hex_s1_agent_m0_address;                                                // pio_hex_s1_agent:m0_address -> pio_hex_s1_translator:uav_address
	...
	wire  [97:0] pio_hex_s1_agent_rf_source_data;                                            // pio_hex_s1_agent:rf_source_data -> pio_hex_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] pio_hex_s1_agent_rsp_fifo_out_data;                                         // pio_hex_s1_agent_rsp_fifo:out_data -> pio_hex_s1_agent:rf_sink_data
	...
	wire         cmd_mux_009_src_valid;                                                      // cmd_mux_009:src_valid -> pio_hex_s1_agent:cp_valid
	wire  [96:0] cmd_mux_009_src_data;                                                       // cmd_mux_009:src_data -> pio_hex_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                      // pio_hex_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [9:0] cmd_mux_009_src_channel;                                                    // cmd_mux_009:src_channel -> pio_hex_s1_agent:cp_channel
	wire         cmd_mux_009_src_startofpacket;                                              // cmd_mux_009:src_startofpacket -> pio_hex_s1_agent:cp_startofpacket
	wire         cmd_mux_009_src_endofpacket;                                                // cmd_mux_009:src_endofpacket -> pio_hex_s1_agent:cp_endofpacket
	...
	wire         onchip_s1_agent_rp_valid;                                                   // onchip_s1_agent:rp_valid -> router_005:sink_valid
	wire  [96:0] onchip_s1_agent_rp_data;                                                    // onchip_s1_agent:rp_data -> router_005:sink_data
	wire         onchip_s1_agent_rp_ready;                                                   // router_005:sink_ready -> onchip_s1_agent:rp_ready
	wire         onchip_s1_agent_rp_startofpacket;                                           // onchip_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         onchip_s1_agent_rp_endofpacket;                                             // onchip_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [96:0] uart_s1_agent_rp_data;                                                      // uart_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [96:0] pio_led_s1_agent_rp_data;                                                   // pio_led_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [96:0] pio_sw_s1_agent_rp_data;                                                    // pio_sw_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [96:0] pio_key_s1_agent_rp_data;                                                   // pio_key_s1_agent:rp_data -> router_010:sink_data
	...
	wire         pio_hex_s1_agent_rp_valid;                                                  // pio_hex_s1_agent:rp_valid -> router_011:sink_valid
	wire  [96:0] pio_hex_s1_agent_rp_data;                                                   // pio_hex_s1_agent:rp_data -> router_011:sink_data
	wire         pio_hex_s1_agent_rp_ready;                                                  // router_011:sink_ready -> pio_hex_s1_agent:rp_ready
	wire         pio_hex_s1_agent_rp_startofpacket;                                          // pio_hex_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire         pio_hex_s1_agent_rp_endofpacket;                                            // pio_hex_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire         onchip_s1_agent_rdata_fifo_src_valid;                                       // onchip_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] onchip_s1_agent_rdata_fifo_src_data;                                        // onchip_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         onchip_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_003:in_0_ready -> onchip_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                          // avalon_st_adapter_003:out_0_valid -> onchip_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                           // avalon_st_adapter_003:out_0_data -> onchip_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                          // onchip_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                          // avalon_st_adapter_003:out_0_error -> onchip_s1_agent:rdata_fifo_sink_error
	...
	wire         pio_hex_s1_agent_rdata_fifo_src_valid;                                      // pio_hex_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire  [33:0] pio_hex_s1_agent_rdata_fifo_src_data;                                       // pio_hex_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire         pio_hex_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_009:in_0_ready -> pio_hex_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_009_out_0_valid;                                          // avalon_st_adapter_009:out_0_valid -> pio_hex_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_009_out_0_data;                                           // avalon_st_adapter_009:out_0_data -> pio_hex_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_009_out_0_ready;                                          // pio_hex_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire   [0:0] avalon_st_adapter_009_out_0_error;                                          // avalon_st_adapter_009:out_0_error -> pio_hex_s1_agent:rdata_fifo_sink_error
